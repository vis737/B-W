...
exports.defaultNewsletter = exports.defaultOrders = exports.defaultCustomers = exports.defaultCms = exports.defaultCampaigns = exports.defaultCoupons = exports.defaultProducts = exports.defaultAgeGroups = exports.defaultCategories = void 0;
const categorySeed = [
...
exports.defaultCategories = categorySeed.map(([name, slug, description], index) => ({
    id: `cat-${index + 1}`,
    name,
    slug,
    description,
...
const adultAges = [exports.defaultAgeGroups[1], exports.defaultAgeGroups[2], exports.defaultAgeGroups[3]];
exports.defaultProducts = [
    {
        ...
        currency: 'USD',
        gender: 'men',
        categories: [exports.defaultCategories[0]],
    ...
    },
    {
        ...
        currency: 'USD',
        gender: 'men',
        categories: [exports.defaultCategories[3]],
        age_groups: adultAges,
    ...
    },
    {
        ...
        currency: 'USD',
        gender: 'men',
        categories: [exports.defaultCategories[7]],
        age_groups: [exports.defaultAgeGroups[0], ...adultAges],
    ...
    },
    {
        ...
        currency: 'USD',
        gender: 'men',
        categories: [exports.defaultCategories[2], exports.defaultCategories[6]],
        age_groups: adultAges,
    ...
    },
    {
        ...
        currency: 'USD',
        gender: 'men',
        categories: [exports.defaultCategories[1]],
        age_groups: [exports.defaultAgeGroups[0], ...adultAges],
    ...
    },
    {
        ...
        currency: 'USD',
        gender: 'men',
        categories: [exports.defaultCategories[4]],
        age_groups: [exports.defaultAgeGroups[0], ...adultAges],
    ...
    },
    {
        ...
        currency: 'USD',
        gender: 'unisex',
        categories: [exports.defaultCategories[8]],
        age_groups: adultAges,
    ...
    },
    {
        ...
        currency: 'USD',
        gender: 'men',
        categories: [exports.defaultCategories[5]],
        age_groups: adultAges,
...
exports.defaultCms = {
    hero: exports.defaultCampaigns[0],
    bank_details: {
